...
void init_charge(double charges[][3]){
    double array[6][3] = {{round((10 * pow(3, 0.5) / 9) * 100) / 100, round(((double)50 / 3 + 20) * 100) / 100, round((40 * pow(6, 0.5) / 9 + 20) * 100) / 100},
    {round((10 * pow(3, 0.5) / 9) * 100) / 100, round((-(double)50 / 3 + 20) * 100) / 100, round((40 * pow(6, 0.5) / 9 + 20) * 100) / 100},
    {round((160 * pow(3, 0.5) / 9) * 100) / 100, 20, round((40 * pow(6, 0.5) / 9 + 20) * 100) / 100},
    {round((10 * pow(3, 0.5) / 9) * 100) / 100, round(((double)50 / 3 + 20) * 100) / 100, round((-40 * pow(6, 0.5) / 9 + 20) * 100) / 100},
    {round((10 * pow(3, 0.5) / 9) * 100) / 100, round((-(double)50 / 3 + 20) * 100) / 100, round((-40 * pow(6, 0.5) / 9 + 20) * 100) / 100},
    {round((160 * pow(3, 0.5) / 9) * 100) / 100, 20, round((-40 * pow(6, 0.5) / 9 + 20) * 100) / 100}};
...
double calc_coulomb_energy(Point point){
    double energy1 = 1 / (pow(point.x - charges[0][0], 2) + pow(point.y - charges[0][1], 2) + pow(point.z - charges[0][2], 2));
    double energy2 = 1 / (pow(point.x - charges[1][0], 2) + pow(point.y - charges[1][1], 2) + pow(point.z - charges[1][2], 2));    
    double energy3 = 1 / (pow(point.x - charges[2][0], 2) + pow(point.y - charges[2][1], 2) + pow(point.z - charges[2][2], 2));
    double energy4 = 1 / (pow(point.x - charges[3][0], 2) + pow(point.y - charges[3][1], 2) + pow(point.z - charges[3][2], 2));
    double energy5 = 1 / (pow(point.x - charges[4][0], 2) + pow(point.y - charges[4][1], 2) + pow(point.z - charges[4][2], 2));
    double energy6 = 1 / (pow(point.x - charges[5][0], 2) + pow(point.y - charges[5][1], 2) + pow(point.z - charges[5][2], 2));

    return (energy1 + energy2 + energy3 + energy4 + energy5 + energy6) * 10;
}
    ...
    for (int i = 0; i < NUM_GENERATION; i++){
        for (int j = 0; j < NUM_INDIVIDUAL; j++){
            for (int k = 0; k < NUM_POINTS - 1; k++){
                ...
                //printf("クーロン: %f\n", calc_coulomb_energy(group[j].points[k]));
            }
